    ...
    <div className="container mx-auto px-4 py-8">
      <section className="mb-10 ">
        ...
        <p className="text-lg leading-relaxed text-center">
          ...
          <br /> 프로젝트와 블로그 기능을 통해 포트폴리오를 체계적으로 관리할 수 있습니다.
          <br />
      ...
      <section className="mb-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 justify-center mx-auto max-w-8xl p-4 relative">
            <div className="flex-1 max-w-[400px]">
              <p className="text-lg leading-relaxed">
                사용자가 자신의 이력서를 Markdown으로 직접 작성하여 메인 페이지에 표시하는 공간입니다.
                <br />
                Markdown을 사용하여 이력서를 다양하게 작성할 수 있으며, 이력서의 구조, 내용, 그리고 디자인을 유연하게
                작성 할 수 있습니다.
                <br />
        ...
        {selectSection === "project" && (
          <div className="flex flex-col md:flex-row items-center gap-10 justify-center mx-auto max-w-8xl p-4 relative">
            <div className="flex-1 max-w-[400px]">
              <p className="text-lg leading-relaxed">
                실시간으로 GitHub와 연동되어 깃허브에 올려둔 자신의 프로젝트를 ArchiLog로 가져와 게시할 수 있습니다.
                <br />이 기능을 통해 자신의 기술력을 실시간으로 업데이트하고, 공유할 수 있으며 발표자료 및 프로젝트를
                쉽고, 효율적으로 관리할 수 있습니다.
              </p>
            </div>
        ...
        {selectSection === "blog" && (
            ...
            <div className="flex-1 max-w-[400px]">
              <p className="text-lg leading-relaxed">
              개발 중 겪은 문제와 해결 과정을 마크다운 형식으로 기록할 수 있습니다. 이력서와 프로젝트 외에도 학습
                기록을 남겨 자기 개발 과정을 꾸준히 보여줄 수 있습니다.
                <br />
                자신만의 블로그를 만들어 보세요!
              </p>
            </div>
      ...
      <section className="my-20  text-center">
        ...
        <p className="text-lg leading-relaxed">
          ...
          기능을 활용하여 경쟁력 있는 포트폴리오와 이력서를 완성해보세요.
        </p>
      </section>
    </div>
  );
