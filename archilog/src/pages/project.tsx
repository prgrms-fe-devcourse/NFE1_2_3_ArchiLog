...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`
        relative overflow-hidden rounded-xl p-4 h-48 cursor-pointer transition-all duration-300
        ${
          isCreateNew
        ...
        } border-2 hover:border-gray-700 group
      `}
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full space-y-4">
        ...
        <h3
          className={`text-center font-medium px-4 py-2 rounded-lg backdrop-blur-sm ${
            darkMode ? "bg-black/30 text-white" : "bg-white/70 text-black"
          }`}
        >
          {title}
        </h3>
